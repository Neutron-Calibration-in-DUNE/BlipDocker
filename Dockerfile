...
RUN pip install --no-cache-dir \
    ...
    uproot seaborn bokeh imageio pytorch-metric-learning \
    torchmetrics ripser panel \
...
RUN git clone --recursive "https://github.com/Neutron-Calibration-in-DUNE/MinkowskiEngine"
RUN cd MinkowskiEngine && \
    git checkout blip-latest && \
